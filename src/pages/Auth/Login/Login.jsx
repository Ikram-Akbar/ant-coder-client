          ...
          <div className="w-full max-w-xs text-center">
            ...
            <div className="mt-8 text-xs text-indigo-100/90">
              ...
              <p className="opacity-90">
                Or continue with a social account below.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            <form className="mt-6 space-y-6" onSubmit={handleSubmit} noValidate>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  type="button"
                  className="w-full inline-flex items-center justify-center px-3 py-2 border border-gray-300 rounded-lg shadow-sm text-sm bg-white hover:bg-gray-50"
                >
                  Google
                </button>
                <button
